...
Scheme
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		"bh_white"													"230 230 230 255"
		"bh_white_t"												"255 230 230 150"
		...
		"TFTanBright"												"230 230 230 255"		// Console/server browser title
		"TFTanLight"												"100 100 100 150"		// Tab and arrow colors in server browser
		"TFTanMedium"												"255 230 230 150"		// Scrollbar color (background)
		...
		"TFTextBright"												"255 230 230 150"		// Main text color (servers, filters, etc; not console)
		"TFTextMedium"												"230 230 230 255"		// "Team Fortress 2" text in Game dropdown (??)
		"TFTextDull"												"230 230 230 255"		// Quick Refresh + Game arrow color (in server browser)
		...
		"SelectionBG"												"230 230 230 255"		// background color of any selected text or menu item
		"SelectionBG2"												"230 230 230 255"		// selection background in window w/o focus
